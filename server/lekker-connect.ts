...
const WID = process.env.LEKKER_WORKSPACE_ID || "40f8ebd5-00d0-4535-b979-8cab9e7b2449";
const TOKEN = process.env.LEKKER_TOKEN || "272b36a9-fa82-4854-95b5-e84cf7b8e3ab";
